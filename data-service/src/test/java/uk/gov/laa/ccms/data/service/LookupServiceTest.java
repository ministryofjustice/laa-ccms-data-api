...
class LookupServiceTest {
  ...
  @Mock private CommonLookupValueRepository commonLookupValueRepository;

  @Mock private CaseStatusLookupValueRepository caseStatusLookupValueRepository;
  ...
  @Mock private StageEndLookupValueRepository stageEndLookupValueRepository;
  ...
  @Mock private AwardTypeLookupValueRepository awardTypeLookupValueRepository;

  @Mock private CategoryOfLawLookupValueRepository categoryOfLawLookupValueRepository;

  @Mock private MatterTypeRepository matterTypeRepository;

  @Mock private ProceedingClientInvolvementTypeRepository proceedingClientInvolvementTypeRepository;

  @Mock private LevelOfServiceRepository levelOfServiceRepository;

  @Mock private EvidenceDocumentTypeLookupValueRepository evidenceDocumentTypeLookupValueRepository;

  @Mock private AssessmentSummaryAttributesRepository assessmentSummaryAttributesRepository;

  @Mock private ProviderRequestTypeRepository providerRequestTypeRepository;

  @Mock private DeclarationRepository declarationRepository;

  @Mock private LookupMapper lookupMapper;

  @Mock private Root<AssessmentSummaryEntity> root;
  ...
  void getCommonValues_returnsPageOfCommonValues() {
    ...
    Page<CommonLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(commonLookupValue));
    ...
    CommonLookupDetail actualResponse =
        lookupService.getCommonLookupValues(
  ...
  void getCommonValuesStartsWithWildcard_createsEndsWithMatcher() {
    ...
    ExampleMatcher wildcardMatcher =
        ExampleMatcher.matchingAll().withMatcher("description", GenericPropertyMatchers.endsWith());

    Example<CommonLookupValue> wildcardExample = Example.of(exampleLookupValue, wildcardMatcher);
    Pageable pageable = Pageable.ofSize(10).withPage(0);
    Page<CommonLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(commonLookupValue));
    CommonLookupDetail expectedResponse = new CommonLookupDetail();
  ...
  void getCaseStatusValues_returnsPageOfCaseStatusValues() {
    ...
    Page<CaseStatusLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(caseStatusLookupValue));
    ...
    CaseStatusLookupDetail actualResponse =
        lookupService.getCaseStatusLookupValues(
  ...
  void getAmendmentTypesValues_returnsPageOfAmendmentTypeValues() {
    ...
    Page<AmendmentTypeLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(amendmentTypeLookupValue));
    ...
    AmendmentTypeLookupDetail actualResponse =
        lookupService.getAmendmentTypeLookupValues(
  ...
  void getCountryValues_returnsPageOfCountryValues() {
    ...
    Pageable pageable = Pageable.ofSize(10).withPage(0);
    Page<CountryLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(countryLookupValue));
    CommonLookupDetail expectedResponse = new CommonLookupDetail();
    ...
    CommonLookupDetail actualResponse =
        lookupService.getCountryLookupValues(countryLookupValue.getCode(), pageable);
  ...
  void getOutcomeResultValues_returnsPageOfValues() {
    ...
    Pageable pageable = Pageable.ofSize(10).withPage(0);
    Page<OutcomeResultLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(outcomeResultLookupValue));
    OutcomeResultLookupDetail expectedResponse = new OutcomeResultLookupDetail();

    when(outcomeResultLookupValueRepository.findAll(example, pageable)).thenReturn(expectedPage);
    when(lookupMapper.toOutcomeResultLookupDetail(expectedPage)).thenReturn(expectedResponse);

    OutcomeResultLookupDetail actualResponse =
        lookupService.getOutcomeResultLookupValues(
  ...
  void getStageEndValues_returnsPageOfValues() {
    ...
    Pageable pageable = Pageable.ofSize(10).withPage(0);
    Page<StageEndLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(stageEndLookupValue));
    StageEndLookupDetail expectedResponse = new StageEndLookupDetail();

    when(stageEndLookupValueRepository.findAll(example, pageable)).thenReturn(expectedPage);
    when(lookupMapper.toStageEndLookupDetail(expectedPage)).thenReturn(expectedResponse);

    StageEndLookupDetail actualResponse =
        lookupService.getStageEndLookupValues(
  ...
  void getPersonToCaseRelationshipValues_returnsPageOfValues() {
    ...
    Example<PersonRelationshipToCaseLookupValue> example =
        Example.of(personRelationshipToCaseLookupValue);
    Pageable pageable = Pageable.ofSize(10).withPage(0);
    Page<PersonRelationshipToCaseLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(personRelationshipToCaseLookupValue));
    ...
    when(lookupMapper.toRelationshipToCaseLookupDetail(expectedPage)).thenReturn(expectedResponse);

    RelationshipToCaseLookupDetail actualResponse =
        lookupService.getPersonToCaseRelationshipLookupValues(
  ...
  void getOrganisationToCaseRelationshipValues_returnsPageOfValues() {
    ...
    Example<OrganisationRelationshipToCaseLookupValue> example =
        Example.of(organisationRelationshipToCaseLookupValue);
    Pageable pageable = Pageable.ofSize(10).withPage(0);
    Page<OrganisationRelationshipToCaseLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(organisationRelationshipToCaseLookupValue));
    RelationshipToCaseLookupDetail expectedResponse = new RelationshipToCaseLookupDetail();
    ...
    RelationshipToCaseLookupDetail actualResponse =
        lookupService.getOrganisationToCaseRelationshipLookupValues(
  ...
  void getAwardTypeValues_returnsPageOfValues() {
    ...
    Pageable pageable = Pageable.ofSize(10).withPage(0);
    Page<AwardTypeLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(awardTypeLookupValue));
    AwardTypeLookupDetail expectedResponse = new AwardTypeLookupDetail();

    when(awardTypeLookupValueRepository.findAll(example, pageable)).thenReturn(expectedPage);
    when(lookupMapper.toAwardTypeLookupDetail(expectedPage)).thenReturn(expectedResponse);

    AwardTypeLookupDetail actualResponse =
        lookupService.getAwardTypeLookupValues(
            awardTypeLookupValue.getCode(), awardTypeLookupValue.getAwardType(), pageable);
  ...
  void getCategoryOfLawValues_returnsPageOfValues() {
    ...
    Pageable pageable = Pageable.ofSize(10).withPage(0);
    Page<CategoryOfLawLookupValue> expectedPage =
        new PageImpl<>(Collections.singletonList(categoryOfLawLookupValue));
    CategoryOfLawLookupDetail expectedResponse = new CategoryOfLawLookupDetail();

    when(categoryOfLawLookupValueRepository.findAll(example, pageable)).thenReturn(expectedPage);
    when(lookupMapper.toCategoryOfLawLookupDetail(expectedPage)).thenReturn(expectedResponse);

    CategoryOfLawLookupDetail actualResponse =
        lookupService.getCategoryOfLawLookupValues(
  ...
  void getMatterTypeLookupValues_returnsPageOfMatterTypeValues() {
    ...
    Page<MatterType> expectedPage = new PageImpl<>(Collections.singletonList(matterTypeEntity));
    MatterTypeLookupDetail expectedResponse = new MatterTypeLookupDetail();

    when(matterTypeRepository.findAll(Example.of(matterTypeEntity), pageable))
        .thenReturn(expectedPage);
    when(lookupMapper.toMatterTypeLookupDetail(expectedPage)).thenReturn(expectedResponse);

    MatterTypeLookupDetail actualResponse =
  ...
  void getClientInvolvementTypeLookupValues_returnsPageOfClientInvolvementTypeValues() {
    ...
    ProceedingClientInvolvementType proceedingClientInvolvementTypeEntity =
    ...
    Page<ProceedingClientInvolvementType> expectedPage =
        new PageImpl<>(Collections.singletonList(proceedingClientInvolvementTypeEntity));
    ClientInvolvementTypeLookupDetail expectedResponse = new ClientInvolvementTypeLookupDetail();

    when(proceedingClientInvolvementTypeRepository.findAll(
            Example.of(proceedingClientInvolvementTypeEntity), pageable))
        .thenReturn(expectedPage);
    when(lookupMapper.toClientInvolvementTypeLookupDetail(expectedPage))
        .thenReturn(expectedResponse);

    ClientInvolvementTypeLookupDetail actualResponse =
        lookupService.getClientInvolvementTypeLookupValues(
  ...
  void getLevelOfServiceLookupValues_returnsPageOfLevelOfServiceValues() {
    ...
    Page<LevelOfService> expectedPage =
        new PageImpl<>(Collections.singletonList(levelOfServiceEntity));
    LevelOfServiceLookupDetail expectedResponse = new LevelOfServiceLookupDetail();

    when(levelOfServiceRepository.findAll(Example.of(levelOfServiceEntity), pageable))
        .thenReturn(expectedPage);
    when(lookupMapper.toLevelOfServicePage(expectedPage)).thenReturn(expectedResponse);

    LevelOfServiceLookupDetail actualResponse =
        lookupService.getLevelOfServiceLookupValues(
  ...
  void getEvidenceDocumentTypeLookupValues_returnsPageOEvidenceDocumentTypeValues() {
    ...
    EvidenceDocumentTypeLookupValueId lookupValueId = new EvidenceDocumentTypeLookupValueId();
    ...
    when(evidenceDocumentTypeLookupValueRepository.findAll(Example.of(lookupValue), pageable))
        .thenReturn(expectedPage);
    when(lookupMapper.toEvidenceDocumentTypeLookupDetail(expectedPage))
        .thenReturn(expectedResponse);
  ...
  void getAssessmentSummaryAttributes_withParentSummaryType_returnsFilteredResults() {
    ...
    when(assessmentSummaryAttributesRepository.findAll(
            any(Specification.class), any(PageRequest.class)))
        .thenReturn(expectedPage);
    when(lookupMapper.toAssessmentSummaryEntityLookupDetail(expectedPage))
        .thenReturn(expectedResponse);

    AssessmentSummaryEntityLookupDetail actualResponse =
        lookupService.getAssessmentSummaryAttributes(summaryType, pageable);
  ...
  void getDeclarationLookupValues_returnsPageOfDeclarationValues() {
    ...
    DeclarationLookupDetail actualResponse =
        lookupService.getDeclarationLookupValues(declarationType, billType, pageable);
  ...
  void getProviderRequestTypeLookupValues_returnsPageOfProviderRequestTypeValues() {
    ...
    when(lookupMapper.toProviderRequestTypeLookupDetail(expectedPage)).thenReturn(expectedResponse);

    ProviderRequestTypeLookupDetail actualResponse =

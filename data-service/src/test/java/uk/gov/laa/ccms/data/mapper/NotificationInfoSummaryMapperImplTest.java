...
class NotificationInfoSummaryMapperImplTest {
  ...
  void shouldReturnNotificationSummaryWithZerosWhenEmptyListPassed() {
    ...
    // Then
    assertEquals(
        new NotificationSummary().notifications(0).standardActions(0).overdueActions(0),
        result,
  ...
  void shouldReturnNotificationSummaryWithListOfZerosPassed() {
    // Given
    List<NotificationCount> counts =
        Arrays.asList(
            NotificationCount.builder()
                .id(withNotificationCountId(NotificationType.NOTIFICATIONS))
                .notificationCount(0)
                .build(),
            NotificationCount.builder()
                .id(withNotificationCountId(NotificationType.ACTION))
                .notificationCount(0)
                .build(),
            NotificationCount.builder()
                .id(withNotificationCountId(NotificationType.OVERDUE))
                .notificationCount(0)
                .build());
    // When
    NotificationSummary result = mapper.toNotificationSummary(counts);
  ...
  void shouldReturnNotificationSummaryWith3Notifications() {
    ...
    // Then
    assertEquals(
        new NotificationSummary().notifications(3).standardActions(0).overdueActions(0),
        result,
        "NotificationInfo summary should only have 3 notifications");
  }

  @Test
  @DisplayName(
      "Should return notification summary with 5 notifications due to multiple NotificationCount objects")
  void shouldReturnNotificationSummaryWith5NotificationsDueToMultipleNotificationCountObjects() {
    ...
    // Then
    assertEquals(
        new NotificationSummary().notifications(5).standardActions(0).overdueActions(0),
        result,
        "NotificationInfo summary should only have 5 notifications");
  }
  ...
  void shouldReturnNotificationSummaryWith5Actions() {
    ...
    // Then
    assertEquals(
        new NotificationSummary().notifications(0).standardActions(5).overdueActions(0),
        result,
        "NotificationInfo summary should only have 5 actions");
  }

  @Test
  @DisplayName(
      "Should return notification summary with 6 actions due to multiple NotificationCount objects")
  void shouldReturnNotificationSummaryWith6ActionsDueToMultipleNotificationCountObjects() {
    ...
    // Then
    assertEquals(
        new NotificationSummary().notifications(0).standardActions(6).overdueActions(0),
        result,
        "NotificationInfo summary should only have 6 actions");
  }
  ...
  void shouldReturnNotificationSummaryWith7Overdue() {
    ...
    // Then
    assertEquals(
        new NotificationSummary().notifications(0).standardActions(0).overdueActions(7),
        result,
        "NotificationInfo summary should only have 7 actions");
  }

  @Test
  @DisplayName(
      "Should return notification summary with 9 overdue due to multiple NotificationCount objects")
  void shouldReturnNotificationSummaryWith9OverdueDueToMultipleNotificationCountObjects() {
    ...
    // Then
    assertEquals(
        new NotificationSummary().notifications(0).standardActions(0).overdueActions(9),
        result,
        "NotificationInfo summary should only have 9 overdue");
  }
  ...
  void shouldReturnNotificationSummaryWithMultipleNotificationTypes() {
    ...
    // Then
    assertEquals(
        new NotificationSummary().notifications(2).standardActions(4).overdueActions(6),
        result,
        "NotificationInfo summary should only have 7 actions");
  }

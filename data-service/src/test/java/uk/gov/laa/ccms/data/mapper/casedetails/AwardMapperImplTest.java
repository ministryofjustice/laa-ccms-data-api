...
import uk.gov.laa.ccms.data.mapper.casedetails.xml.casedetail.award.AmountXml;
import uk.gov.laa.ccms.data.mapper.casedetails.xml.casedetail.award.AwardDetailsXml;
...
import uk.gov.laa.ccms.data.mapper.casedetails.xml.casedetail.award.OfferedAmountXml;
import uk.gov.laa.ccms.data.mapper.casedetails.xml.casedetail.award.OtherAssetXml;
import uk.gov.laa.ccms.data.mapper.casedetails.xml.casedetail.award.RecoveredAmountXml;
import uk.gov.laa.ccms.data.mapper.casedetails.xml.casedetail.award.RecoveryXml;
import uk.gov.laa.ccms.data.mapper.casedetails.xml.casedetail.award.ServiceAddressXml;
import uk.gov.laa.ccms.data.mapper.casedetails.xml.casedetail.award.TimeRelatedAwardXml;
import uk.gov.laa.ccms.data.mapper.casedetails.xml.casedetail.award.ValuationXml;
...
public class AwardMapperImplTest {
  ...
  void shouldMapFinancialAwardDetails() {
    ...
    SoftAssertions.assertSoftly(
        softly -> {
          ...
          softly
              .assertThat(result.getLiableParties())
              .containsExactlyInAnyOrder("Party 1", "Party 2");
  ...
  void shouldMapLandAwardValues() {
    // Given
    LandAwardXml landAwardXml =
        LandAwardXml.builder()
            ...
            .propertyAddress(
                ServiceAddressXml.builder()
                    .addressLine1("Line 1")
                    .addressLine2("Line 2")
                    .addressLine3("Line 3")
                    .build())
            .valuation(
                ValuationXml.builder()
                    .amount("100")
                    .criteria("Criteria")
                    .date(LocalDate.of(2015, 5, 5))
                    .build())
            .timeRelatedAward(
                TimeRelatedAwardXml.builder()
                    .awardType("Type")
                    .description("Description")
                    .amount("50")
    ...
    SoftAssertions.assertSoftly(
        softly -> {
          ...
          softly
              .assertThat(result.getStatChargeExemptReason())
              .isEqualTo("Stat charge exempt reason");
          softly
              .assertThat(result.getLandChargeRegistration())
              .isEqualTo("Land charge registration");
          softly.assertThat(result.getRegistrationRef()).isEqualTo("Registration ref");
          softly
              .assertThat(result.getOtherProprietors())
              .containsExactlyInAnyOrder("Proprietor 1", "Proprietor 2");
          ...
          softly
              .assertThat(timeRelatedAward.getAwardTriggeringEvent())
              .isEqualTo("Triggering event");
  ...
  void shouldMapCostAwardValues() {
    ...
    SoftAssertions.assertSoftly(
        softly -> {
          ...
          softly
              .assertThat(result.getCertificateCostRateMarket())
              .isEqualTo(BigDecimal.valueOf(160L));
          softly.assertThat(result.getAwardedBy()).isEqualTo("Awarded By");
          softly.assertThat(result.getInterestAwardedRate()).isEqualTo(BigDecimal.valueOf(180L));
          softly
              .assertThat(result.getInterestAwardedStartDate())
  ...
  void shouldMapCostAwardDetailsRecoveryValues() {
    ...
    SoftAssertions.assertSoftly(
        softly -> {
          ...
          softly
              .assertThat(recoveredAmount.getSolicitor().getAmount())
              .isEqualTo(BigDecimal.valueOf(10l));
          softly
              .assertThat(recoveredAmount.getSolicitor().getPaidToLsc())
              .isEqualTo(BigDecimal.valueOf(20l));
          softly
              .assertThat(recoveredAmount.getSolicitor().getDateReceived())
              .isEqualTo(LocalDate.of(2020, 1, 1));
          softly
              .assertThat(recoveredAmount.getCourt().getAmount())
              .isEqualTo(BigDecimal.valueOf(20l));
          softly
              .assertThat(recoveredAmount.getCourt().getPaidToLsc())
              .isEqualTo(BigDecimal.valueOf(30l));
          softly
              .assertThat(recoveredAmount.getCourt().getDateReceived())
              .isEqualTo(LocalDate.of(2020, 2, 1));
          softly
              .assertThat(recoveredAmount.getClient().getAmount())
              .isEqualTo(BigDecimal.valueOf(30l));
          softly
              .assertThat(recoveredAmount.getClient().getPaidToLsc())
              .isEqualTo(BigDecimal.valueOf(40l));
          softly
              .assertThat(recoveredAmount.getClient().getDateReceived())
              .isEqualTo(LocalDate.of(2020, 3, 1));
        });
  }
  ...
  void shouldMapOtherAssetValues() {
    // Given
    OtherAssetXml otherAssetXml =
        OtherAssetXml.builder()
  ...
  private static RecoveryXml getRecoveryXml() {
    return RecoveryXml.builder()
        ...
        .offeredAmount(
            OfferedAmountXml.builder()
                .amount("40")
                .conditionsOfOffer("Conditions of offer")
                .build())
        .recoveredAmount(
            RecoveredAmountXml.builder()
                .solicitor(
                    AmountXml.builder()
                        .amount("10")
                        .paidToLsc(20l)
                        .dateReceived(LocalDate.of(2020, 1, 1))
                        .build())
                .court(
                    AmountXml.builder()
                        .amount("20")
                        .paidToLsc(30l)
                        .dateReceived(LocalDate.of(2020, 2, 1))
                        .build())
                .client(
                    AmountXml.builder()
                        .amount("30")
                        .paidToLsc(40l)
                        .dateReceived(LocalDate.of(2020, 3, 1))
                        .build())
                .build())
        .build();
  }

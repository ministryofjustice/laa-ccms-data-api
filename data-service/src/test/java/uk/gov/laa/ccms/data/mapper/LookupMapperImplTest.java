...
class LookupMapperImplTest {
  ...
  void toCommonLookupValueListDetails() {
    ...
    expected.setContent(
        mapper.commonLookupValueListToCommonLookupValueDetailList(
            commonLookupValuePage.getContent()));
  ...
  void commonLookupValueToCommonLookupValueDetails() {
    ...
    CommonLookupValueDetail actualDetails =
        mapper.commonLookupValueToCommonLookupValueDetail(commonLookupValue);
  ...
  void commonLookupValueListToCommonLookupValueDetailsList() {
    ...
    List<CommonLookupValueDetail> actualDetailsList =
        mapper.commonLookupValueListToCommonLookupValueDetailList(commonLookupValues);
  ...
  void toCaseStatusLookupValueListDetails() {
    ...
    expected.setContent(
        mapper.caseStatusLookupValueListToCaseStatusLookupValueDetailList(
  ...
  void caseStatusLookupValueToCaseStatusLookupValueDetails() {
    ...
    CaseStatusLookupValueDetail expectedDetails =
        createCaseStatusLookupValueDetail(caseStatusLookupValue);
  ...
  void toAmendmentTypeLookupDetailTest() {
    ...
    Page<AmendmentTypeLookupValue> amendmentTypeLookupValuePage =
        new PageImpl<>(amendmentTypeLookupValues);
    ...
    AmendmentTypeLookupDetail actualDetail =
        mapper.toAmendmentTypeLookupDetail(amendmentTypeLookupValuePage);
  ...
  void toCommonLookupDetailFromCountriesTest() {
    ...
    CommonLookupDetail actualDetail =
        mapper.toCommonLookupDetailFromCountries(countryLookupValuePage);
  ...
  void toOutcomeResultLookupValueDetailTest() {
    ...
    OutcomeResultLookupValueDetail actualDetail = mapper.toOutcomeResultLookupValueDetail(value);
  ...
  void toStageEndLookupValueDetailTest() {
    ...
    StageEndLookupValueDetail actualDetail = mapper.toStageEndLookupValueDetail(value);
  ...
  void toStageEndLookupDetailTest() {
    ...
    List<StageEndLookupValueDetail> actualDetailsList =
        mapper.stageEndLookupValueListToStageEndLookupValueDetailList(stageEndLookupValues);
  ...
  void toRelationshipToCaseLookupValueDetail() {
    ...
    RelationshipToCaseLookupValueDetail expectedDetail =
        createRelationshipToCaseLookupValueDetail(value);
  ...
  void toOrgRelationshipToCaseLookupValueDetail() {
    OrganisationRelationshipToCaseLookupValue value =
        createOrganisationRelationshipToCaseLookupvalue("1");
  ...
  void toAwardTypeLookupValueDetailTest() {
    ...
    AwardTypeLookupValueDetail actualDetail = mapper.toAwardTypeLookupValueDetail(value);
  ...
  void toAwardTypeLookupDetailTest() {
    ...
    AwardTypeLookupDetail actualDetail = mapper.toAwardTypeLookupDetail(page);
  ...
  void toCategoryOfLawLookupValueDetailTest() {
    ...
    CategoryOfLawLookupValueDetail actualDetail = mapper.toCategoryOfLawLookupValueDetail(value);
  ...
  void toCategoryOfLawLookupDetailTest() {
    ...
    CategoryOfLawLookupDetail actualDetail = mapper.toCategoryOfLawLookupDetail(page);
  ...
  void matterTypeToMatterTypeLookupValueDetail_returnsCorrectDetail() {
    ...
    MatterTypeLookupValueDetail expected =
        createMatterTypeLookupValueDetail("MAT1", "desc", "CAT1");
  ...
  void matterTypeListToMatterTypeLookupValueDetailList_returnsCorrectList() {
    ...
    MatterTypeLookupValueDetail expected1 =
        createMatterTypeLookupValueDetail("MAT1", "desc1", "CAT1");
    MatterTypeLookupValueDetail expected2 =
        createMatterTypeLookupValueDetail("MAT2", "desc2", "CAT2");

    List<MatterTypeLookupValueDetail> expected = Arrays.asList(expected1, expected2);

    List<MatterTypeLookupValueDetail> actual =
        mapper.matterTypeListToMatterTypeLookupValueDetailList(matterTypes);
  ...
  void levelOfServiceListToLevelOfServiceLookupValueDetailList_returnsCorrectList() {
    ...
    LevelOfServiceLookupValueDetail expected1 =
        createLevelOfServiceLookupValueDetail("MAT1", "PRO1", "CAT1");
    LevelOfServiceLookupValueDetail expected2 =
        createLevelOfServiceLookupValueDetail("MAT2", "PRO2", "CAT2");

    List<LevelOfServiceLookupValueDetail> expected = Arrays.asList(expected1, expected2);

    List<LevelOfServiceLookupValueDetail> actual =
        mapper.levelOfServiceListToLevelOfServiceLookupValueDetailList(levelOfServices);
  ...
  void toLevelOfServicePage_returnsCorrectDetail() {
    ...
    expected.setSize(page.getSize());
    expected.setContent(
        mapper.levelOfServiceListToLevelOfServiceLookupValueDetailList(page.getContent()));
  ...
  @Test
  void
      proceedingClientInvolvementTypeListToClientInvolvementTypeLookupValueDetailList_returnsCorrectList() {
    ProceedingClientInvolvementType proceedingClientInvolvementType1 =
        createProceedingClientInvolvementType("PRO1", "INV1");
    ProceedingClientInvolvementType proceedingClientInvolvementType2 =
        createProceedingClientInvolvementType("PRO2", "INV2");

    List<ProceedingClientInvolvementType> proceedingClientInvolvementTypes =
        Arrays.asList(proceedingClientInvolvementType1, proceedingClientInvolvementType2);

    ClientInvolvementTypeLookupValueDetail expected1 =
        createClientInvolvementTypeLookupValueDetail("PRO1", "INV1");
    ClientInvolvementTypeLookupValueDetail expected2 =
        createClientInvolvementTypeLookupValueDetail("PRO2", "INV2");

    List<ClientInvolvementTypeLookupValueDetail> expected = Arrays.asList(expected1, expected2);

    List<ClientInvolvementTypeLookupValueDetail> actual =
        mapper.proceedingClientInvolvementTypeListToClientInvolvementTypeLookupValueDetailList(
  ...
  void toOutcomeResultLookupDetail_returnsCorrectDetail() {
    ...
    expected.setSize(page.getSize());
    expected.setContent(
        mapper.outcomeResultLookupValueListToOutcomeResultLookupValueDetailList(page.getContent()));
  ...
  void toStageEndLookupDetail_returnsCorrectDetail() {
    ...
    expected.setSize(page.getSize());
    expected.setContent(
        mapper.stageEndLookupValueListToStageEndLookupValueDetailList(page.getContent()));
  ...
  private LevelOfService createLevelOfService(
      String matterType, String proceedingCode, String categoryOfLawCode) {
  ...
  private LevelOfServiceLookupValueDetail createLevelOfServiceLookupValueDetail(
      String matterType, String proceedingCode, String categoryOfLawCode) {
  ...
  private MatterType createMatterType(
      String matterTypeCode, String description, String categoryOfLawCode) {
  ...
  private MatterTypeLookupValueDetail createMatterTypeLookupValueDetail(
      String matterTypeCode, String description, String categoryOfLawCode) {
  ...
  private ProceedingClientInvolvementType createProceedingClientInvolvementType(
      String proceedingCode, String clientInvolvementType) {
    ProceedingClientInvolvementType proceedingClientInvolvementType =
        new ProceedingClientInvolvementType();
  ...
  private ClientInvolvementTypeLookupValueDetail createClientInvolvementTypeLookupValueDetail(
      String proceedingCode, String clientInvolvementType) {
  ...
  private OrganisationRelationshipToCaseLookupValue createOrganisationRelationshipToCaseLookupvalue(
      String suffix) {
  ...
  private PersonRelationshipToCaseLookupValue createPersonRelationshipToCaseLookupvalue(
      String suffix) {
    PersonRelationshipToCaseLookupValue personRelationshipToCaseLookupValue =
        new PersonRelationshipToCaseLookupValue();
  ...
  private AwardTypeLookupValueDetail createAwardTypeLookupValueDetail(
    ...
    detail.setStartDateActive(
        awardTypeLookupValue.getStartDateActive().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
    detail.setEndDateActive(
        awardTypeLookupValue.getEndDateActive().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
  ...
  private AmendmentTypeLookupValueDetail createAmendmentTypeLookupValueDetail(
      AmendmentTypeLookupValue value) {
  ...
  private CommonLookupValueDetail createCommonLookupValueDetails(
      CommonLookupValue commonLookupValue) {
    ...
    detail.setStartDateActive(
        commonLookupValue.getStartDateActive().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
  ...
  private CaseStatusLookupValueDetail createCaseStatusLookupValueDetail(
      CaseStatusLookupValue caseStatusLookupValue) {
  ...
  private EvidenceDocumentTypeLookupValue createEvidenceDocumentTypeLookupValue(String suffix) {
    ...
    lookupValue.setId(new EvidenceDocumentTypeLookupValueId("type" + suffix, "code" + suffix));
  ...
  private EvidenceDocumentTypeLookupValueDetail creatEvidenceDocumentTypeLookupValueDetail(
    ...
    detail.setStartDateActive(
        lookupValue.getStartDateActive().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
    detail.setEndDateActive(
        lookupValue.getEndDateActive().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
  ...
  void toAssessmentSummaryEntityLookupDetailTest() {
    ...
    expectedDetail.setContent(
        mapper.assessmentSummaryEntityListToAssessmentSummaryEntityLookupValueDetailList(
            entityPage.getContent()));

    AssessmentSummaryEntityLookupDetail actualDetail =
        mapper.toAssessmentSummaryEntityLookupDetail(entityPage);
  ...
  void toAssessmentSummaryEntityLookupDetail_nullTest() {
    AssessmentSummaryEntityLookupDetail actualDetail =
        mapper.toAssessmentSummaryEntityLookupDetail(null);
  ...
  void toAssessmentSummaryEntityLookupValueDetailTest() {
    ...
    AssessmentSummaryEntityLookupValueDetail expectedDetail =
        createAssessmentSummaryEntityLookupValueDetail(entity);
    AssessmentSummaryEntityLookupValueDetail actualDetail =
        mapper.toAssessmentSummaryEntityLookupValueDetail(entity);
  ...
  void toAssessmentSummaryEntityLookupValueDetail_nullTest() {
    AssessmentSummaryEntityLookupValueDetail actualDetail =
        mapper.toAssessmentSummaryEntityLookupValueDetail(null);
    assertNull(actualDetail);
  }
  ...
  void toAssessmentSummaryAttributeLookupValueDetailTest() {
    ...
    AssessmentSummaryAttributeLookupValueDetail expectedDetail =
        createAssessmentSummaryAttributeLookupValueDetail(attribute);
    AssessmentSummaryAttributeLookupValueDetail actualDetail =
        mapper.toAssessmentSummaryAttributeLookupValueDetail(attribute);
  ...
  void toAssessmentSummaryAttributeLookupValueDetail_nullTest() {
    AssessmentSummaryAttributeLookupValueDetail actualDetail =
        mapper.toAssessmentSummaryAttributeLookupValueDetail(null);
    assertNull(actualDetail);
  }
  ...
  private AssessmentSummaryEntityLookupValueDetail createAssessmentSummaryEntityLookupValueDetail(
      AssessmentSummaryEntity entity) {
    AssessmentSummaryEntityLookupValueDetail detail =
    ...
    detail.setAttributes(
        mapper.assessmentSummaryAttributeListToAssessmentSummaryAttributeLookupValueDetailList(
            entity.getAttributes()));
    return detail;
  }

  private AssessmentSummaryAttributeLookupValueDetail
      createAssessmentSummaryAttributeLookupValueDetail(AssessmentSummaryAttribute attribute) {
    AssessmentSummaryAttributeLookupValueDetail detail =
  ...
  @Test
  @DisplayName(
      "toProviderRequestTypeLookupDetail returns correct detail for a given page of provider request types")
  void toProviderRequestTypeLookupDetail_returnsCorrectDetail() {
    ...
    Page<ProviderRequestType> page =
        new PageImpl<>(List.of(providerRequestType1, providerRequestType2));
    ...
    expected.setSize(page.getSize());
    expected.setContent(
        mapper.providerRequestTypeListToProviderRequestTypeLookupValueDetailList(
            page.getContent()));
  ...
  @Test
  @DisplayName(
      "toProviderRequestTypeLookupValueDetail returns correct detail for a given provider request type")
  void toProviderRequestTypeLookupValueDetail_returnsCorrectDetail() {
    ...
    ProviderRequestTypeLookupValueDetail actual =
        mapper.toProviderRequestTypeLookupValueDetail(providerRequestType);
  ...
  @Test
  @DisplayName(
      "toProviderRequestTypeLookupValueDetail returns null when input provider request type is null")

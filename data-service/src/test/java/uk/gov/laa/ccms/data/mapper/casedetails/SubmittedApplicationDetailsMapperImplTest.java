...
class SubmittedApplicationDetailsMapperImplTest {
  ...
  void shouldMapRootLevelSubmittedApplicationDetails() {
    // Given
    ApplicationDetailsXml applicationDetailsXml =
        ApplicationDetailsXml.builder()
            .client(getClientXml())
    ...
    SubmittedApplicationDetails result =
        mapper.mapToSubmittedApplicationDetails(applicationDetailsXml);
    // Then
  ...
  void shouldMapProceedings() {
    ...
    SoftAssertions.assertSoftly(
        softly -> {
          ...
          softly
              .assertThat(scopeLimitation.getScopeLimitationId())
              .isEqualTo("Scope limitation id");
          softly.assertThat(scopeLimitation.getScopeLimitation()).isEqualTo("Scope limitation");
          softly
              .assertThat(scopeLimitation.getScopeLimitationWording())
              .isEqualTo("Scope limitation wording");
  ...
  private static OtherPartyXml getOtherPartyPerson() {
    return OtherPartyXml.builder()
        ...
        .otherPartyDetail(OtherPartyDetailXml.builder().person(getPerson()).build())
        .build();
  }
  ...
  private static ProviderDetailsXml getProviderDetails() {
    return ProviderDetailsXml.builder()
        ...
        .contactUserId(ContactUserIdXml.builder().userLoginId(123).userName("UserName").build())
    ...
    return PersonXml.builder()
        ...
        .address(
            AddressXml.builder()
                ...
                .postalCode("Postal code")
                .build())
        .contactDetails(new ContactDetailsXml("123", "456", "789", "email@email.com", "246"))
  ...
  private static OtherPartyXml getOtherPartyOrganisation() {
    return OtherPartyXml.builder()
        ...
        .sharedIndicator(true)
        .otherPartyDetail(
            OtherPartyDetailXml.builder()
                .organisation(
                    OrganisationXml.builder()
                        .organisationName("Org Name")

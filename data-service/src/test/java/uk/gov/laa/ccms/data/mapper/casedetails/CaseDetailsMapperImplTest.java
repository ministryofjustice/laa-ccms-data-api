...
class CaseDetailsMapperImplTest {
  ...
  CaseDetailsMapper mapper =
      new CaseDetailsMapperImpl(
  ...
  void shouldMapRootLevelCaseDetailValues() {
    // Given
    CaseDetailXml caseDetailXml =
        CaseDetailXml.builder()
            .caseReferenceNumber("12345")
            .caseDetails(
                CaseDetailsXml.builder()
  ...
  void shouldMapDischargeValues() {
    ...
    SoftAssertions.assertSoftly(
        softly -> {
          ...
          softly
              .assertThat(result.getDischargeStatus().getOtherDetails())
              .isEqualTo("Other details");
        });
  }

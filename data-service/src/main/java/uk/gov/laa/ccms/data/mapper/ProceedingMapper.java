 ...
 * representations.
 *
 * <p>This interface provides methods for transforming {@code Proceeding} entities to detailed data
 * transfer objects(DTOs) like {@code ProceedingDetail}. It leverages the MapStruct library, with
 * the Spring component model, for automatic generation of the implementation at compile-time.
 *
 * @see Mapper
 * @see Proceeding

 ...
 * operations for the {@code CaseStatusLookupValue} entity, identified by a primary key of type
 * {@code String}.
 *
 ...
 */
@Repository
public interface CaseStatusLookupValueRepository
    extends ReadOnlyRepository<CaseStatusLookupValue, String> {}

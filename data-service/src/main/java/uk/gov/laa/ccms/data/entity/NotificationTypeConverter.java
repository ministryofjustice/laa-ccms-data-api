...
public class NotificationTypeConverter implements AttributeConverter<NotificationType, String> {
  ...
  /**
   * Converts a database column value (String) to the corresponding NotificationType enumeration value.
   *
   * @param dbData the database column value that represents a NotificationType; may be null.
   * @return the NotificationType corresponding to the given database value, or null if the input is null.

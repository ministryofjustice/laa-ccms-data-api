...
/**
 * Case detail object, which contains both the case reference number, and an object containing all
 * of additional information relating to this case.
 *
 * @see CaseDetailsXml
 * @author Jamie Briggs
 */
...
public record CaseDetailXml(
    ...
    @JacksonXmlProperty(
            localName = "CaseDetails",
            namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
        CaseDetailsXml caseDetails,
    @JacksonXmlProperty(localName = "Message", namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
        MessageXml message) {}

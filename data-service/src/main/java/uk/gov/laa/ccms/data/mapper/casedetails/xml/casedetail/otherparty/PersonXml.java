...
public class PersonXml {
  ...
  @JacksonXmlProperty(localName = "DateOfBirth", namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  ...
  @JacksonXmlProperty(localName = "NINumber", namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  ...
  @JacksonXmlProperty(
      localName = "PartyLegalAidedInd",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private Boolean partyLegalAidedInd;

  @JacksonXmlProperty(
      localName = "CourtOrderedMeansAssessment",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private Boolean courtOrderedMeansAssessment;

  @JacksonXmlProperty(
      localName = "AssessedIncomeFrequency",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private String assessedIncomeFrequency;

  @JacksonXmlProperty(
      localName = "AssessedIncome",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private BigDecimal assessedIncome;

  @JacksonXmlProperty(
      localName = "AssessedAssets",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private BigDecimal assessedAssets;

  @JacksonXmlProperty(
      localName = "AssessmentDate",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private LocalDate assessmentDate;

  @JacksonXmlProperty(
      localName = "PublicFundingAppliedInd",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  ...
  @JacksonXmlProperty(
      localName = "OrganizationAddress",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private String organisationAddress;

  @JacksonXmlProperty(
      localName = "EmployersName",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private String employersName;

  @JacksonXmlProperty(
      localName = "EmploymentStatus",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private String employmentStatus;

  @JacksonXmlProperty(
      localName = "CertificateNumber",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)

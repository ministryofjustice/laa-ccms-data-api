...
/**
 * Interface responsible for mapping objects from {@link ClientDetail} to {@link ClientSummary} and
 * {@link ClientDetails} objects. This interface utilizes MapStruct or mapping properties.
 *
 * @see ClientDetail
 * @see ClientSummary
 * @see ClientDetails
...
public interface ClientDetailsMapper {
   ...
   * @return a {@link ClientDetails} object containing transformed search results along with
   *     pagination metadata.
   */

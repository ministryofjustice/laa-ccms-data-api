...
public final class ProceedingXml {
  ...
  @JacksonXmlProperty(
      localName = "ProceedingCaseID",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private String proceedingCaseId;

  @JacksonXmlProperty(localName = "DateApplied", namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private LocalDate dateApplied;

  @JacksonXmlProperty(localName = "Status", namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private String status;

  @JacksonXmlProperty(
      localName = "LeadProceedingIndicator",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)

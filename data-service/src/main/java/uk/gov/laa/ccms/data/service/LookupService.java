...
public class LookupService extends AbstractEbsDataService {
   ...
   * information. If wildcard is true, a 'like' query will be performed for all three attributes.
   *
  ...
  public CommonLookupDetail getCommonLookupValues(
      final String type, final String code, final String description, final Pageable pageable) {
    ...
    return lookupMapper.toCommonLookupDetail(
        commonLookupValueRepository.findAll(
            Example.of(example, getWildcardMatcher(example)), pageable));
  }

  /**
   * Retrieves a page of case status values based on the provided code, copyAllowed flag and
  ...
  public CaseStatusLookupDetail getCaseStatusLookupValues(
      final String code, final Boolean copyAllowed, final Pageable pageable) {
  ...
  public AmendmentTypeLookupDetail getAmendmentTypeLookupValues(
      final String applicationType, final Pageable pageable) {
   ...
   */
  public CommonLookupDetail getCountryLookupValues(final String code, final Pageable pageable) {
   ...
   * @param pageable The pagination information.
   * @return A {@link ClientInvolvementTypeLookupDetail} object containing a page of {@link
   *     ProceedingClientInvolvementType} entities that match the criteria.
   */
  public ClientInvolvementTypeLookupDetail getClientInvolvementTypeLookupValues(
      final String proceedingCode, final String clientInvolvementType, final Pageable pageable) {
   ...
   * @param categoryOfLaw The category of law.
   * @param pageable The pagination information.
   * @return A {@link LevelOfServiceLookupDetail} object containing a page of {@link LevelOfService}
   *     entities that match the criteria.
   */
  ...
  public OutcomeResultLookupDetail getOutcomeResultLookupValues(
      final String proceedingCode, final String outcomeResult, final Pageable pageable) {
  ...
  public StageEndLookupDetail getStageEndLookupValues(
      final String proceedingCode, final String stageEnd, final Pageable pageable) {
  ...
  public RelationshipToCaseLookupDetail getPersonToCaseRelationshipLookupValues(
      final String code, final String description, final Pageable pageable) {
  ...
  public AwardTypeLookupDetail getAwardTypeLookupValues(
      final String code, final String awardType, final Pageable pageable) {
  ...
  public EvidenceDocumentTypeLookupDetail getEvidenceDocumentTypeLookupValues(
      final String type, final String code, final Pageable pageable) {
  ...
  public DeclarationLookupDetail getDeclarationLookupValues(
      final String declarationType, final String billType, final Pageable pageable) {
    ...
    return lookupMapper.toDeclarationLookupDetail(declarations);
  }

  /**
   * Retrieves the assessment summary attributes based on the provided summary type and pagination
   * details.
   *
  ...
  public AssessmentSummaryEntityLookupDetail getAssessmentSummaryAttributes(
      String summaryType, final Pageable pageable) {

    return lookupMapper.toAssessmentSummaryEntityLookupDetail(
        assessmentSummaryAttributesRepository.findAll(
            buildQuerySpecification(Example.of(new AssessmentSummaryEntity()), summaryType),
            PageRequest.of(
  ...
  protected Specification<AssessmentSummaryEntity> buildQuerySpecification(
      final Example<AssessmentSummaryEntity> summaryEntity, final String summaryType) {
    ...
    return (root, query, builder) -> {
      ...
      Predicate examplePredicate =
          QueryByExamplePredicateBuilder.getPredicate(root, builder, summaryEntity);

...
public class LookupService {
   ...
   */
  public Page<CommonLookupValue> getCommonLookupValues(
          Example<CommonLookupValue> example, Pageable pageable) {
    return commonLookupValueRepository.findAll(example, pageable);
  }

  /**
   * Retrieves a page of case status values based on the provided example and pagination
   * information.
   *
   * @param example  the example of the common values
   * @param pageable pagination information
   ...
   */
  public Page<CaseStatusLookupValue> getCaseStatusLookupValues(
          Example<CaseStatusLookupValue> example, Pageable pageable) {
    return caseStatusLookupValueRepository.findAll(example, pageable);
  }

  /**
   * Retrieves a page of amendment type values based on the provided example and pagination
   * information.
   *

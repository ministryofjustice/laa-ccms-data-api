...
/**
 * Repository for performing operations on the {@link CaseSearch} entity. This repository is
 ...
 * represents case data from the <b>XXCCMS_CASE_SEARCH_V</b> view in the database.
 *
 * @see CaseSearch
 * @see EntityManager
...
public class CaseSearchRepository extends BaseEntityManagerRepository<CaseSearch> {
  ...
  /**
   * Constructs a new instance of {@link CaseSearchRepository}, which is responsible for performing
   * database operations on {@link CaseSearch} entities using the provided {@link EntityManager}.
   *

 ...
 *
 * <p>This entity corresponds to the "XXCCMS_APP_CASE_STATUS_V" table in the database. The JSON
 ...
 * whether copying is allowed for this particular status.
 *
...
@Table(name = "XXCCMS_APP_CASE_STATUS_V", schema = "XXCCMS")
@Immutable

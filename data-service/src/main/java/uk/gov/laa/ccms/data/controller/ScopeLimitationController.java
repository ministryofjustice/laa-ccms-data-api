 ...
 *
 * <p>This controller provides endpoints for retrieving scope limitation values.
 */
@RestController
...
public class ScopeLimitationController implements ScopelimitationsApi {
   ...
   */
  @Override
  public ResponseEntity<ScopeLimitationDetails> getScopeLimitations(
      ...
      BigDecimal emergencyCostLimitation,
      Boolean nonStandardWording,
      Boolean emergencyScopeDefault,
      Boolean emergency,
      Boolean defaultCode,

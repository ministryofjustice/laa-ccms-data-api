 ...
 *
 * <p>This controller serves as an interface to manage Prior Authority data and actions. It
 * delegates the business logic to the {@link PriorAuthorityService}
 *
...
public class PriorAuthorityController implements PriorAuthorityTypesApi {
   ...
   * @return ResponseEntity with the PriorAuthorityTypeDetails if found, or
   *     ResponseEntity.notFound() if not found
   */
  @Override
  public ResponseEntity<PriorAuthorityTypeDetails> getPriorAuthorityTypes(

...
/**
 * Repository for performing operations on the {@link NotificationInfo} entity. This repository is
 ...
 * entities, which represents notification data from the <b>XXCCMS_GET_NOTIF_INFO_V</b> view in the
 * database.
 *
...
public class NotificationSearchRepository extends BaseEntityManagerRepository<NotificationInfo> {
   ...
   * performing database operations on {@link NotificationInfo} entities using the provided {@link
   * EntityManager}.
   *

...
public final class AddressXml {
  ...
  @JacksonXmlProperty(localName = "HouseOrTitle", namespace = "http://legalservices.gov.uk/Enterprise/Common/1.0/Common")
  ...
  @JacksonXmlProperty(localName = "AddressLine3", namespace = "http://legalservices.gov.uk/Enterprise/Common/1.0/Common")
  private String addressLine3;
  @JacksonXmlProperty(localName = "AddressLine4", namespace = "http://legalservices.gov.uk/Enterprise/Common/1.0/Common")
  ...
  @JacksonXmlProperty(localName = "State", namespace = "http://legalservices.gov.uk/Enterprise/Common/1.0/Common")
  private String state;
  @JacksonXmlProperty(localName = "Province", namespace = "http://legalservices.gov.uk/Enterprise/Common/1.0/Common")

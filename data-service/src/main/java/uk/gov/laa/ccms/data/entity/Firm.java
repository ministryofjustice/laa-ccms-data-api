 ...
 *
 * <p>This entity captures essential details about a firm, such as its unique identifier, name, and
 * the end date associated with the user of the firm.
 */
@Data
@Entity
@NoArgsConstructor
...
public class Firm implements Serializable {
  ...
  /**
   * The end date of the user associated with the firm. This field is ignored during JSON

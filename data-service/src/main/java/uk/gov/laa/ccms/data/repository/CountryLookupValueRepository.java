 ...
 * operations for the {@code CountryLookupValue} entity, identified by a primary key of type {@code
 * String}.
 *
 * @see uk.gov.laa.ccms.data.entity.CountryLookupValue
 * @see ReadOnlyRepository
 */
public interface CountryLookupValueRepository
    extends ReadOnlyRepository<CountryLookupValue, CountryLookupValueId> {}

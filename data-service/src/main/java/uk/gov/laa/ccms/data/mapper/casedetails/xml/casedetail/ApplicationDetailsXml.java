...
public final class ApplicationDetailsXml {
  ...
  @JacksonXmlProperty(
      localName = "PreferredAddress",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private String preferredAddress;

  @JacksonXmlProperty(
      localName = "CorrespondenceAddress",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private CorrespondenceAddressXml correspondenceAddress;

  @JacksonXmlProperty(
      localName = "ProviderDetails",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private ProviderDetailsXml providerDetails;

  @JacksonXmlProperty(
      localName = "CategoryOfLaw",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private CategoryOfLawXml categoryOfLaw;

  @JacksonXmlProperty(
      localName = "OtherParties",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private List<OtherPartyXml> otherParties;

  @JacksonXmlProperty(localName = "Proceedings", namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private List<ProceedingXml> proceedings;

  @JacksonXmlProperty(
      localName = "PurposeOfApplication",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private String purposeOfApplication;

  @JacksonXmlProperty(
      localName = "FixedHearingDateInd",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private Boolean fixedHearingDateIndicator;

  @JacksonXmlProperty(
      localName = "PurposeOfHearing",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private String purposeOfHearing;

  @JacksonXmlProperty(
      localName = "HighProfileCaseInd",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private Boolean highProfileCaseIndicator;

  @JacksonXmlProperty(
      localName = "ApplicationAmendmentType",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private String applicationAmendmentType;

  @JacksonXmlProperty(localName = "LARDetails", namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private LarDetailsXml larDetails;

  @JacksonXmlProperty(
      localName = "DateOfFirstAttendance",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private LocalDate dateOfFirstAttendance;

  @JacksonXmlProperty(
      localName = "DateOfHearing",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)
  private LocalDate dateOfHearing;

  @JacksonXmlProperty(
      localName = "DevolvedPowersDate",
      namespace = CaseDetailXmlNamespaces.CASE_NAMESPACE)

...
@Sql(
    ...
    scripts = {"/sql/case_search_create_schema.sql"})
@Sql(
    executionPhase = ExecutionPhase.AFTER_TEST_CLASS,
    scripts = {"/sql/case_search_drop_schema.sql"})
...
class CaseSearchRepositoryIntegrationTest implements OracleIntegrationTestInterface {
  ...
  @Autowired private CaseSearchRepository caseSearchRepository;
  ...
  void shouldGetAllCaseSearchRowsUsingProviderId() {
    // Given
    // When
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, null, null, null, null, null),
  ...
  void shouldFindNoCaseSearchRowsWhenProviderIdDoesNotMatch() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(200L, "3001", null, null, null, null, null),
            Pageable.ofSize(10).withPage(0));
    // Then
  ...
  void shouldFilterByCaseReferenceNumber() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, "3001", null, null, null, null, null),
            Pageable.ofSize(10).withPage(0));
    // Then
  ...
  void shouldNotFilterLikeCaseReferenceNumber() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, "300", null, null, null, null, null),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(0, result.getTotalElements());
  }
  ...
  void shouldFilterByProviderCaseReferenceNumber() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, "6001", null, null, null, null),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(1, result.getTotalElements());
    assertEquals(result.getContent().getFirst().getLscCaseReference(), "3001");
  ...
  void shouldFilterLikeProviderCaseReferenceNumber() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, "600", null, null, null, null),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(2, result.getTotalElements());
    assertEquals(result.getContent().getFirst().getLscCaseReference(), "3001");
  ...
  void shouldFilterExactlyStatus() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, null, "ONE", null, null, null),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(1, result.getTotalElements());
    assertEquals(result.getContent().getFirst().getLscCaseReference(), "3001");
  ...
  void shouldFilterExactlyStatusTwo() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, null, "TWO", null, null, null),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(1, result.getTotalElements());
  ...
  void shouldFilterExactlyStatusNone() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, null, "ON", null, null, null),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(0, result.getTotalElements());
  }
  ...
  void shouldFilterByClientSurname() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, null, null, "Last Two", null, null),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(1, result.getTotalElements());
  ...
  void shouldFilterLikeClientSurname() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, null, null, "Last", null, null),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(2, result.getTotalElements());
    assertEquals(result.getContent().getFirst().getLscCaseReference(), "3001");
  ...
  void shouldFilterEqualFeeEarnerId() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, null, null, null, 9001L, null),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(1, result.getTotalElements());
    assertEquals(result.getContent().getFirst().getLscCaseReference(), "3001");
  ...
  void shouldFilterEqualFeeEarnerIdReturnNone() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, null, null, null, 900L, null),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(0, result.getTotalElements());
  }
  ...
  void shouldFilterEqualOfficeId() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, null, null, null, null, 8001L),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(1, result.getTotalElements());
    assertEquals(result.getContent().getFirst().getLscCaseReference(), "3001");
  ...
  void shouldFilterEqualOfficeIdReturnNone() {
    ...
    Page<CaseSearch> result =
        caseSearchRepository.findAll(
            CaseSearchSpecification.filterBy(100L, null, null, null, null, null, 800L),
            Pageable.ofSize(10).withPage(0));
    // Then
    assertEquals(0, result.getTotalElements());
  }

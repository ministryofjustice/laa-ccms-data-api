...
public class PriorAuthorityServiceIntegrationTest extends AbstractIntegrationTest {
    ...
    @ParameterizedTest
    @Sql(statements = {
            "INSERT INTO XXCCMS_PRIOR_AUTHORITY_TYPE_V (CODE, DESCRIPTION, VALUE_REQUIRED_FLAG) " +
                    "VALUES ('TYPE1', 'Auth Type 1', 'Y');",
            "INSERT INTO XXCCMS_PRIOR_AUTHORITY_TYPE_V (CODE, DESCRIPTION, VALUE_REQUIRED_FLAG) " +
                    "VALUES ('TYPE2', 'Auth Type 2', 'N');",
            "INSERT INTO XXCCMS_PRIOR_AUTH_DETAILS_V (CODE, DESCRIPTION, DATA_TYPE, LOV_CODE, MANDATORY_FLAG, PRIOR_AUTHORITY_TYPE_CODE) " +
    ...
    public void testGetPriorAuthorityTypes(String code, Boolean valueRequired, Integer expectedSubElements) {

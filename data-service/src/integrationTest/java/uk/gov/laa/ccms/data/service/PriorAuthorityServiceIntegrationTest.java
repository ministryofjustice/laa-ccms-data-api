...
public class PriorAuthorityServiceIntegrationTest implements OracleIntegrationTestInterface {
  ...
  @Autowired private PriorAuthorityService priorAuthorityService;
  ...
  @CsvSource(
      value = {"TYPE1, null, 2", "TYPE1, true, 2", "TYPE2, false, 0"},
      nullValues = "null")
  public void testGetPriorAuthorityTypes(
      String code, Boolean valueRequired, Integer expectedSubElements) {

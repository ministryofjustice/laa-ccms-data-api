...
public class LookupServiceIntegrationTest implements OracleIntegrationTestInterface {
  ...
  public void testGetAmendmentTypes(String code, String expectedDescription) {
    ...
    assertEquals(
        expectedDescription, result.getContent().getFirst().getApplicationTypeDescription());
  }
  ...
  @CsvSource(
      ...
      nullValues = {"null"})
  public void testGetCommonValues(String type, String code, String desc, Integer expectedElements) {
    // Create a pageable object
    Pageable pageable = PageRequest.of(0, 10);

    // Call the repository method
    CommonLookupDetail result = lookupService.getCommonLookupValues(type, code, desc, pageable);
  ...
  @CsvSource(
      value = {"code1, null, 2", "code1, Result 2, 1", "null, null, 2"},
      nullValues = {"null"})
  public void testGetOutcomeResults(String code, String results, Integer expectedElements) {
    ...
    // Call the repository method
    OutcomeResultLookupDetail result =
        lookupService.getOutcomeResultLookupValues(code, results, pageable);
  ...
  @CsvSource(
      value = {"code1, null, 2", "code1, StageEnd 2, 1", "null, null, 2"},
      nullValues = {"null"})
  public void testGetStageEnds(String code, String stageEnd, Integer expectedElements) {
    ...
    // Call the repository method
    StageEndLookupDetail result = lookupService.getStageEndLookupValues(code, stageEnd, pageable);
  ...
  @CsvSource(
      ...
      nullValues = {"null"})
  public void testGetPersonRelationshipsToCase(
      String code, String description, Integer expectedElements) {
    // Create a pageable object
    Pageable pageable = PageRequest.of(0, 10);

    // Call the repository method
    RelationshipToCaseLookupDetail result =
  ...
  @CsvSource(
      ...
      nullValues = {"null"})
  public void testGetOrganisationRelationshipsToCase(
      String code, String description, Integer expectedElements) {
    // Create a pageable object
    Pageable pageable = PageRequest.of(0, 10);
  ...
  @CsvSource(
      value = {"COST, null, 1", "null, AWARD1, 2", "null, null, 3"},
      nullValues = {"null"})
  public void testGetAwardTypes(String code, String awardType, Integer expectedElements) {
    ...
    // Call the repository method
    AwardTypeLookupDetail result =
        lookupService.getAwardTypeLookupValues(code, awardType, pageable);
  ...
  @CsvSource(
      value = {"CAT1, null, null, 1", "null, Mat 1, null, 2", "null, null, false, 1"},
      nullValues = {"null"})
  public void testGetCategoriesOfLaw(
      String code, String desc, Boolean copyCostLimit, Integer expectedElements) {
    // Create a pageable object
    Pageable pageable = PageRequest.of(0, 10);

    // Call the repository method
    CategoryOfLawLookupDetail result =
        lookupService.getCategoryOfLawLookupValues(code, desc, copyCostLimit, pageable);
  ...
  @CsvSource(
      value = {"TYPE1, null, 2", "TYPE1, CODE2, 1", "null, CODE2, 2"},
      nullValues = {"null"})
  public void testGetEvidenceDocumentTypes(String type, String code, Integer expectedElements) {
    ...
    EvidenceDocumentTypeLookupDetail result =
  ...
  @CsvSource(
      value = {"PARENT, 1", "CHILD, 2", "UNKNOWN, 3", "null, 3"},
      nullValues = {"null"})
  public void testGetAssessmentSummaryAttributes(String summaryType, Integer expectedElements) {
    ...
    // Call the service method
    AssessmentSummaryEntityLookupDetail result =
  ...
  public void testGetProviderRequestTypeLookupValues(
      Boolean isCaseRelated, Integer expectedResults) {
    Pageable pageable = PageRequest.of(0, 10);

    ProviderRequestTypeLookupDetail result =
        lookupService.getProviderRequestTypeLookupValues(isCaseRelated, null, pageable);
  ...
  @CsvSource({"TYPE1, Provider Type 1", "TYPE2, Provider Type 2"})
  public void testGetProviderRequestTypeLookupValuesByType(String type, String expectedName) {
    Pageable pageable = PageRequest.of(0, 10);

    ProviderRequestTypeLookupDetail result =
        lookupService.getProviderRequestTypeLookupValues(null, type, pageable);

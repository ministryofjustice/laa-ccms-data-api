...
CREATE TABLE XXCCMS.XXCCMS_COUNSELS_V (
    COUNSEL_ID NUMBER(15)NOT NULL,
    NAME VARCHAR2(360) NOT NULL,
    COMPANY VARCHAR2(240),
    ADVOCATE_LEVEL VARCHAR2(150),
    COUNTY VARCHAR2(60),
    OUTWARD_POST_CODE VARCHAR2(240),
    LEGAL_AID_SUPP_NUMBER VARCHAR2(15) NOT NULL
);
